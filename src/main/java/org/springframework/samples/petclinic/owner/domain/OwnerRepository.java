 ...
 * extended for Spring Data. See: https://docs.spring.io/spring-data/jpa/docs/current/reference/html/#repositories.query-methods.query-creation
 *
 * @author Ken Krebs
...
public interface OwnerRepository extends Repository<Owner, Integer> {
    ...
    /**
     * Retrieve {@link Owner}s from the data store by last name, returning total count of owners whose last name <i>starts</i> with the given name.
     * 
     * @param lastName Value to search for
