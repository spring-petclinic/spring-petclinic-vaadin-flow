...
public abstract class OwnerFormView extends VerticalLayout {
    ...
    OwnerFormView(OwnerFormPresenter<? extends OwnerFormView> presenter) {
        ...
        binder.forField(firstNameTextField).asRequired().bind(Owner::getFirstName, Owner::setFirstName);

        TextField lastNameTextField = new TextField();
        binder.forField(lastNameTextField).asRequired().bind(Owner::getLastName, Owner::setLastName);
