...
import org.springframework.samples.petclinic.owner.view.OwnersFindView;
import org.springframework.samples.petclinic.vet.view.VetsView;
...
public class MainLayout extends AppLayout {
    ...
    private RouterLink createRouterLink(String translationKey, VaadinIcon viewIcon, Class<? extends Component> navigationTarget) {
        final RouterLink routerLink = new RouterLink(getTranslation(translationKey), navigationTarget);
